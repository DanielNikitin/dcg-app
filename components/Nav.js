...
export const navData = [
  ...
  { name: 'RACING', path: '/racing', icon: <MdSportsScore /> },
  { name: 'ECOLOGY', path: '/ecology', icon: <MdEco /> },
  { name: 'TURBO', path: '/turbo', icon: <TbCarTurbine /> },
  { name: 'FAQ', path: '/faq', icon: <MdOutlineContactSupport /> },
];
